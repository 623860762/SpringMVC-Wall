...
<body>
	<div align="center">
		<div class="ass_div_center">
		<span class="ass_span_font">既有线挡土墙安全评估系统</span><br><br><br><br>
		<span><a id="gotoSys" class="ass_sub_button">进入系统</a></span><br><br><br>
		<span class="td_css">天津大学</span>
		</div>
	</div>
...
<script>
	$(function(){
		$("#gotoSys").click(function(){
			esourcing.util.goUrlSelf("assWallController.do?method=forWallPersist");
			});
	});
</script>
</body>
