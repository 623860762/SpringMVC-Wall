...
<body>
		...
		<table class="table_common">
			<tr>
				<td colspan="8" style="text-align:center;">
					...
					<span class="column_head_word">受力状况</span>
					</span>
				</td>
			</tr>	
	...
	<tr>
    	<td class="table_td2">位移:</td><td><input style="width:45px;" type="text"/></td>
    	<td class=""><input style="width:45px;" type="text"/></td><td><input style="width:45px;" type="text"/></td>
    	<td class=""><input style="width:45px;" type="text"/></td><td><input style="width:45px;" type="text"/></td>
    	<td class=""><input style="width:45px;" type="text"/></td><td><input style="width:45px;" type="text"/></td>
    </tr>
	<tr>
    	<td class="table_td2">裂缝:</td><td><input style="width:45px;" type="text"/></td>
    	<td class=""><input style="width:45px;" type="text"/></td><td><input style="width:45px;" type="text"/></td>
    	<td class=""><input style="width:45px;" type="text"/></td><td><input style="width:45px;" type="text"/></td>
    	<td class=""><input style="width:45px;" type="text"/></td><td><input style="width:45px;" type="text"/></td>
    </tr>
	<tr>
    	<td class="table_td2">应力/应变:</td><td><input style="width:45px;" type="text"/></td>
    	<td class=""><input style="width:45px;" type="text"/></td><td><input style="width:45px;" type="text"/></td>
    	<td class=""><input style="width:45px;" type="text"/></td><td><input style="width:45px;" type="text"/></td>
    	<td class=""><input style="width:45px;" type="text"/></td><td><input style="width:45px;" type="text"/></td>
    </tr>
