...
<body>
		...
		<table class="table_common">
			<tr>
				<td colspan="8" style="text-align:center;">
					...
					<span class="column_head_word">材质状况</span>
					</span>
				</td>
			</tr>	
	...
	<tr>
    	<td class="table_td2">混凝土/片石:</td><td><input style="width:45px;" type="text"/></td>
    	<td class=""><input style="width:45px;" type="text"/></td><td><input style="width:45px;" type="text"/></td>
    	<td class=""><input style="width:45px;" type="text"/></td><td><input style="width:45px;" type="text"/></td>
    	<td class=""><input style="width:45px;" type="text"/></td><td><input style="width:45px;" type="text"/></td>
    </tr>
	<tr>
    	<td class="table_td2">砂浆状况:</td><td><input style="width:45px;" type="text"/></td>
    	<td class=""><input style="width:45px;" type="text"/></td><td><input style="width:45px;" type="text"/></td>
    	<td class=""><input style="width:45px;" type="text"/></td><td><input style="width:45px;" type="text"/></td>
    	<td class=""><input style="width:45px;" type="text"/></td><td><input style="width:45px;" type="text"/></td>
    </tr>
